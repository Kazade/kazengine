...
public:
    ...
    scene_node_interface* get_parent() {
    ...
    */
    ...
    const Mat4 get_absolute_transformation() const {
        return m_absolute_transformation;
    }
...
protected:
    ...
    scene_manager_interface* get_scene_manager() const {
