...
class engine_interface {
    public:
        ...
        virtual shared_ptr<Logger> get_logger() = 0;
        virtual shared_ptr<scene_manager_interface> get_scene_manager() = 0;
        virtual shared_ptr<graphics_driver_interface> get_graphics_driver() = 0;

        virtual shared_ptr<IWindow> get_window() = 0;
